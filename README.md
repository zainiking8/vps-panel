...
```bash
apt update && apt install -y curl && curl -o /usr/local/bin/menu https://raw.githubusercontent.com/zainiking8/vps-panel/main/main/menu.sh && chmod +x /usr/local/bin/menu && menu
```
